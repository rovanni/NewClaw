...
const SEMANTIC_RULES: SemanticRule[] = [
    {
        category: 'creation',
        modelCategory: 'code',
        keywords: ['código', 'programar', 'html', 'css', 'js', 'python', 'script', 'bug', 'debug', 'arquivo', 'file', 'criar', 'gerar', 'fazer', 'build', 'escrever', 'montar', 'desenvolver'],
    ...
    },
    {
        ...
        keywords: ['imagem', 'foto', 'screenshot', 'print', 'ocr', 'ver'],
