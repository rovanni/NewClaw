...
const TRANSLATIONS = {
  'pt-BR': {
    ...
    ml_add_provider_title: "➕ Adicionar provider OpenAI-Compatible (LM Studio / vLLM / OpenAI / custom)",
  ...
  'en-US': {
    ...
    ml_add_provider_title: "➕ Add OpenAI-Compatible provider (LM Studio / vLLM / OpenAI / custom)",
    ml_provider_baseurl_label: "Base URL",
  ...
  'es-ES': {
    ...
    ml_add_provider_title: "➕ Agregar proveedor OpenAI-Compatible (LM Studio / vLLM / OpenAI / custom)",
