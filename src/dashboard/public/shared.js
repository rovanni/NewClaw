...
const TRANSLATIONS = {
  'pt-BR': {
    ...
    status_executing_tool: "🔧 Usando {tool}...",
    status_tool_web_search: "🔍 Pesquisando na internet...",
    status_tool_web_navigate: "🌐 Navegando na web...",
    status_tool_weather: "🌤️ Consultando a previsão do tempo...",
    status_tool_crypto_analysis: "💰 Analisando criptomoedas...",
    status_tool_crypto_report: "📊 Gerando relatório de criptomoedas...",
    status_tool_memory_search: "🧠 Consultando a memória...",
    status_tool_memory_write: "🧠 Salvando na memória...",
    status_tool_memory_admin: "🧠 Organizando a memória...",
    status_tool_manage_memory: "🧠 Gerenciando a memória...",
    status_tool_write: "✍️ Escrevendo arquivo...",
    status_tool_edit: "✏️ Editando arquivo...",
    status_tool_read: "📖 Lendo arquivo...",
    status_tool_read_document: "📄 Lendo documento...",
    status_tool_list_workspace: "📁 Listando arquivos...",
    status_tool_refresh_workspace: "📁 Atualizando o workspace...",
    status_tool_organize_workspace: "🗂️ Organizando arquivos...",
    status_tool_analyze_workspace_groups: "🗂️ Analisando arquivos...",
    status_tool_exec_command: "⚙️ Executando comando...",
    status_tool_ssh_exec: "🔐 Executando comando remoto...",
    status_tool_api_request: "🌐 Consultando uma API...",
    status_tool_cmi_inspect: "🔍 Inspecionando a conversa...",
    status_tool_send_document: "📎 Enviando o documento...",
    status_tool_send_audio: "🔊 Gerando áudio...",
    status_tool_powerpoint_control: "📊 Controlando o PowerPoint...",
    status_tool_schedule: "⏰ Agendando...",
    status_synthesizing: "✍️ Preparando a resposta...",
    status_goal_replanning: "🔄 Ajustando o plano...",
    status_goal_executing: "⚙️ Trabalhando no seu pedido...",
    status_error: "❌ Erro",
    ...
    main_ollama_model_label: "Modelo de fallback do Ollama",
    main_ollama_model_hint: "Usado apenas quando uma chamada ao Ollama não especifica um modelo. Normalmente, o Model Router define o modelo por categoria.",
    ...
    // Mensagens transitórias que sobraram fora do i18n (issue 016) — o texto estrutural já
    // tinha sido convertido; estas viviam soltas em 4 telas diferentes.
    ui_error_prefix: "Erro",
    ui_model_ready: "✅ \"{model}\" pronto!",
    ui_mode_changed: "✅ Modo alterado para {mode}",
    ui_save_password_error: "❌ Erro ao salvar senha",
    ml_ov_pending_title: "⏳ Alteração ainda não salva",
    ml_ov_pending_desc: "Você alterou: {campos}. O quadro acima mostra o que está valendo AGORA no servidor — clique em <strong>Salvar</strong> para a sua alteração passar a valer.",
    ml_tab_advanced: "Avançado",
    ml_tab_wizard: "Assistente de Configuração",
    ...
    ml_ov_loading: "carregando o modelo…",
    ml_dup_endpoint_title: "ℹ️ Dois provedores no mesmo endereço",
    ml_dup_endpoint_item: "<strong>{labels}</strong> apontam para <code>{endereco}</code> — é o mesmo servidor com dois nomes. Funciona, mas se algo der errado não haverá como saber qual dos dois está atendendo.",
    ...
    ml_routing_apply_why_nosel: "Selecione um modelo na lista abaixo para poder aplicar.",
    ml_routing_apply_why_same: "{model} já é o modelo aplicado nesta categoria — não há o que mudar.",
    ...
    ml_tab_providers_guide: "🔌 Aqui você conecta o NewClaw a um serviço de IA.<br><br>O <strong>Ollama</strong> vem apontado para o seu computador (localhost:11434), mas os modelos padrão são os <strong>:cloud</strong> — esses rodam nos servidores da Ollama, são <strong>pagos</strong> e exigem uma chave de API (campo abaixo).<br>Para não ter custo, instale um modelo <strong>local</strong> em <strong>Adicionar Modelo</strong> e selecione-o em <strong>Escolher Modelo</strong>.<br>Quer usar outro serviço (Google Gemini, OpenRouter, etc.)? Cole a chave de API dele aqui.",
    ...
    ml_cw_browse_btn: "Procurar...",
    ml_cw_browse_hint: "Abre uma janela para escolher a pasta",
    ml_cw_browse_title: "Escolha a pasta dos modelos",
    ml_cw_browse_empty: "Nenhuma subpasta aqui.",
    ml_cw_browse_up: "Subir",
    ml_cw_browse_use: "Usar esta pasta",
    ...
    ml_param_temp: "Temperatura da amostragem. Mais alto = respostas mais variadas; mais baixo = mais previsíveis. Cada modelo costuma ter uma recomendação oficial diferente.",
    ml_param_topp: "Corta a amostragem nos tokens mais prováveis até somar esta probabilidade. Valores comuns: 0.9 a 0.95.",
    ml_param_topk: "Limita a amostragem aos N tokens mais prováveis a cada passo.",
    ml_param_minp: "Descarta tokens com probabilidade muito menor que a do mais provável. Alternativa mais moderna ao top-p/top-k.",
    ml_param_repeatpenalty: "Penaliza tokens já usados recentemente, para reduzir repetição.",
    ml_param_presencepenalty: "Penaliza qualquer token que já apareceu na resposta, incentivando vocabulário novo.",
    ml_param_flashattn: "Usa atenção otimizada (mais rápida, menos memória) quando o servidor e a GPU suportam.",
    ml_param_jinja: "Usa o template de chat embutido no arquivo do modelo (formato Jinja) em vez do padrão do servidor.",
    ...
    ml_wizard_entry_btn: "Assistente de Configuração Rápida",
    ml_wizard_loading: "Verificando…",
    ml_wizard_step1_title: "Onde estão seus modelos?",
    ml_wizard_step1_hint: "Informe a pasta no seu computador onde ficam os arquivos .gguf.",
    ml_wizard_step_load_title: "Escolha um modelo pra carregar",
    ml_wizard_step_load_hint: "Modelos maiores levam mais tempo pra carregar.",
    ml_wizard_step_confirming: 'Confirmando que "{model}" está pronto para uso…',
    ml_wizard_step_done: '✅ Tudo pronto! O NewClaw já está conversando com "{model}".',
    ml_wizard_close_btn: "Fechar",
    ml_wizard_dismiss_btn: "Não destacar este botão novamente",
    ml_cw_choose_title: "Qual provedor você quer configurar?",
    ml_cw_choose_hint: "Escolha um provedor pra começar — as etapas seguintes mudam conforme o que ele precisa.",
    ml_cw_provider_custom: "Outro / OpenAI-Compatible",
    ml_cw_wip_title: "Em construção",
    ml_cw_wip_hint: "Esta etapa ainda está sendo construída — volte em breve.",
    ml_cw_btn_cancel: "Cancelar",
    ml_cw_btn_back: "← Voltar",
    ml_cw_btn_next: "Próximo →",
    ml_cw_btn_finish: "Concluir",
    ml_cw_ollama_mode_title: "Ollama: local ou nuvem?",
    ml_cw_ollama_mode_hint: "Local usa modelos baixados no seu computador. Cloud usa modelos maiores na nuvem do Ollama — o Ollama instalado no seu computador faz a ponte com essa nuvem (autenticada por chave), por isso ainda precisa dele rodando localmente.",
    ml_cw_ollama_mode_local: "Local",
    ml_cw_ollama_mode_cloud: "Cloud",
    ml_cw_ollama_config_local_title: "Endereço do Ollama",
    ml_cw_ollama_config_local_hint: "Padrão: http://localhost:11434 — só mude se o Ollama estiver em outra máquina/porta.",
    ml_cw_ollama_config_cloud_title: "Ollama Cloud",
    ml_cw_ollama_config_cloud_hint: "A chave do Ollama Cloud é usada junto com o Ollama local — ele continua precisando estar rodando.",
    ml_cw_ollama_url_label: "Endereço (URL)",
    ml_cw_ollama_key_label: "Chave da Ollama Cloud (opcional se já configurada)",
    ml_cw_test_connection_btn: "🔌 Testar conexão",
    ml_cw_testing: "Testando…",
    ml_cw_ollama_connected: "Conectado — {count} modelo(s) disponível(is)",
    ml_cw_ollama_offline_generic: "Não foi possível conectar a este endereço.",
    ml_cw_ollama_models_title: "Escolha um modelo",
    ml_cw_ollama_models_hint: "Selecionar é recomendado, mas não obrigatório — o Ollama continua funcionando com o modelo já configurado antes, se houver.",
    ml_cw_ollama_models_empty: "Nenhum modelo encontrado ainda.",
    ml_cw_conclusion_ready: "Tudo pronto!",
    ml_cw_conclusion_confirming: "Confirmando…",
    ml_cw_conclusion_model: "Modelo: {model}",
    ml_cw_custom_endpoint_title: "Endereço do servidor",
    ml_cw_custom_endpoint_hint: "Qualquer servidor compatível com a API da OpenAI: OpenAI oficial, LM Studio, vLLM, llamafile, ou um endereço seu.",
    ml_cw_custom_label_label: "Nome (pra você identificar depois)",
    ml_cw_custom_url_label: "Endereço (URL)",
    ml_cw_custom_key_label: "Chave de API (opcional)",
    ml_cw_custom_label_required: "Preencha o nome e o endereço antes de testar.",
    ml_cw_custom_offline_generic: "Não foi possível conectar a este endereço.",
    ml_cw_custom_connected: "Conectado — {count} modelo(s) disponível(is)",
    ml_cw_custom_models_title: "Escolha um modelo",
    ml_cw_custom_models_hint: "Selecionar é recomendado, mas não obrigatório — servidores de modelo único (como llamafile) funcionam sem escolher nada.",
    ml_cw_custom_models_empty: "O servidor respondeu, mas não listou nenhum modelo.",
    ml_cw_custom_no_model_caveat: "Sem modelo escolhido, isso só funciona de verdade em servidores de modelo único (llamafile). Servidores com vários modelos (LM Studio, vLLM, OpenAI oficial) provavelmente precisam de um nome específico.",
    ml_cw_local_scanned: "Pasta encontrada — {count} arquivo(s) .gguf",
    ml_cw_native_credential_title: "Chave de API — {name}",
    ml_cw_native_credential_hint: "Cole sua chave de API abaixo. Ela é salva e verificada junto — não existe um teste separado que não grave nada, porque este provider só confirma a chave de verdade depois de ativá-la no servidor.",
    ml_cw_native_verify_btn: "🔌 Salvar e verificar",
    ml_cw_native_validating_title: "Verificando chave e buscando modelos…",
    ml_cw_native_validating_hint: "Isso deve levar poucos segundos.",
    ml_cw_native_offline_generic: "Não foi possível confirmar a chave. Confira se ela está correta e tente de novo.",
    ...
    ml_local_orphaned_title: '🖥️ O modelo "{model}" ainda está carregado, mas não é mais usado',
    ml_local_orphaned_hint: 'Você trocou o provedor em uso — este modelo local continua ocupando a placa de vídeo à toa. O NewClaw não o descarrega sozinho de propósito (a mesma decisão de nunca carregar sozinho, ao contrário): você pode querer mantê-lo no ar para outra coisa.',
  ...
  'en-US': {
    ...
    status_executing_tool: "🔧 Using {tool}...",
    status_tool_web_search: "🔍 Searching the internet...",
    status_tool_web_navigate: "🌐 Browsing the web...",
    status_tool_weather: "🌤️ Checking the weather forecast...",
    status_tool_crypto_analysis: "💰 Analyzing cryptocurrencies...",
    status_tool_crypto_report: "📊 Generating crypto report...",
    status_tool_memory_search: "🧠 Searching memory...",
    status_tool_memory_write: "🧠 Saving to memory...",
    status_tool_memory_admin: "🧠 Managing memory...",
    status_tool_manage_memory: "🧠 Managing memory...",
    status_tool_write: "✍️ Writing file...",
    status_tool_edit: "✏️ Editing file...",
    status_tool_read: "📖 Reading file...",
    status_tool_read_document: "📄 Reading document...",
    status_tool_list_workspace: "📁 Listing files...",
    status_tool_refresh_workspace: "📁 Refreshing workspace...",
    status_tool_organize_workspace: "🗂️ Organizing files...",
    status_tool_analyze_workspace_groups: "🗂️ Analyzing files...",
    status_tool_exec_command: "⚙️ Running command...",
    status_tool_ssh_exec: "🔐 Running remote command...",
    status_tool_api_request: "🌐 Calling an API...",
    status_tool_cmi_inspect: "🔍 Inspecting the conversation...",
    status_tool_send_document: "📎 Sending the document...",
    status_tool_send_audio: "🔊 Generating audio...",
    status_tool_powerpoint_control: "📊 Controlling PowerPoint...",
    status_tool_schedule: "⏰ Scheduling...",
    status_synthesizing: "✍️ Preparing the answer...",
    status_goal_replanning: "🔄 Adjusting the plan...",
    status_goal_executing: "⚙️ Working on your request...",
    status_error: "❌ Error",
    ...
    main_ollama_model_label: "Ollama Fallback Model",
    main_ollama_model_hint: "Used only when an Ollama call does not specify a model. Normally the Model Router sets the model per category.",
    ...
    ui_model_ready: "✅ \"{model}\" ready!",
    ui_mode_changed: "✅ Mode changed to {mode}",
    ui_save_password_error: "❌ Failed to save password",
    ml_ov_pending_title: "⏳ Change not saved yet",
    ml_ov_pending_desc: "You changed: {campos}. The panel above shows what is in effect on the server RIGHT NOW — click <strong>Save</strong> to make your change take effect.",
    ml_tab_advanced: "Advanced",
    ml_tab_wizard: "Setup Assistant",
    ...
    ml_ov_online: "Online",
    ml_ov_offline: "Offline",
    ml_ov_loading: "loading the model…",
    ml_dup_endpoint_title: "ℹ️ Two providers on the same address",
    ml_dup_endpoint_item: "<strong>{labels}</strong> both point to <code>{endereco}</code> — it is the same server under two names. It works, but if something goes wrong there is no way to tell which one is answering.",
    ...
    ml_routing_apply_why_nosel: "Pick a model from the list below to enable Apply.",
    ml_routing_apply_why_same: "{model} is already the model applied to this category — nothing to change.",
    ...
    ml_ov_guide: "👋 First time here? Follow this order:<br><br>1️⃣ <strong>Providers</strong> — connect the AI (Ollama, Gemini, OpenRouter…). Note: Ollama's <strong>:cloud</strong> models are paid and need an API key; only a local model is free.<br>2️⃣ <strong>Add Model</strong> — download one from the internet <em>or</em> use one you already have on your computer.<br>3️⃣ <strong>Choose Model</strong> — decide which model handles each type of task (chat, code, etc).<br><br>💾 Already have model files on your PC? Go to <strong>Add Model → My files</strong>.<br><br>Then click <strong>Save & Restart</strong> in the sidebar.",
    ...
    ml_tab_providers_guide: "🔌 Here you connect NewClaw to an AI service.<br><br><strong>Ollama</strong> points to your own machine (localhost:11434), but the default models are the <strong>:cloud</strong> ones — those run on Ollama's servers, are <strong>paid</strong> and require an API key (field below).<br>To run at no cost, install a <strong>local</strong> model under <strong>Add Model</strong> and select it under <strong>Choose Model</strong>.<br>Want to use another service (Google Gemini, OpenRouter, etc.)? Paste its API key here.",
    ...
    ml_cw_browse_btn: "Browse...",
    ml_cw_browse_hint: "Opens a window to choose the folder",
    ml_cw_browse_title: "Choose the models folder",
    ml_cw_browse_empty: "No subfolders here.",
    ml_cw_browse_up: "Up",
    ml_cw_browse_use: "Use this folder",
    ...
    ml_param_temp: "Sampling temperature. Higher = more varied answers; lower = more predictable. Each model usually has a different official recommendation.",
    ml_param_topp: "Cuts sampling to the most likely tokens until this probability is reached. Common values: 0.9 to 0.95.",
    ml_param_topk: "Limits sampling to the N most likely tokens at each step.",
    ml_param_minp: "Discards tokens with probability much lower than the most likely one. A more modern alternative to top-p/top-k.",
    ml_param_repeatpenalty: "Penalizes recently used tokens, to reduce repetition.",
    ml_param_presencepenalty: "Penalizes any token that already appeared in the response, encouraging new vocabulary.",
    ml_param_flashattn: "Uses optimized attention (faster, less memory) when the server and GPU support it.",
    ml_param_jinja: "Uses the chat template embedded in the model file (Jinja format) instead of the server's default.",
    ...
    ml_wizard_entry_btn: "Quick Setup Assistant",
    ml_wizard_loading: "Checking…",
    ml_wizard_step1_title: "Where are your models?",
    ml_wizard_step1_hint: "Enter the folder on your computer where the .gguf files are.",
    ml_wizard_step_load_title: "Pick a model to load",
    ml_wizard_step_load_hint: "Larger models take longer to load.",
    ml_wizard_step_confirming: 'Confirming that "{model}" is ready to use…',
    ml_wizard_step_done: '✅ All set! NewClaw is now talking to "{model}".',
    ml_wizard_close_btn: "Close",
    ml_wizard_dismiss_btn: "Don't highlight this button again",
    ml_cw_choose_title: "Which provider do you want to configure?",
    ml_cw_choose_hint: "Pick a provider to start — the following steps change depending on what it needs.",
    ml_cw_provider_custom: "Other / OpenAI-Compatible",
    ml_cw_wip_title: "Under construction",
    ml_cw_wip_hint: "This step is still being built — check back soon.",
    ml_cw_btn_cancel: "Cancel",
    ml_cw_btn_back: "← Back",
    ml_cw_btn_next: "Next →",
    ml_cw_btn_finish: "Finish",
    ml_cw_ollama_mode_title: "Ollama: local or cloud?",
    ml_cw_ollama_mode_hint: "Local uses models downloaded on your machine. Cloud uses bigger models hosted on Ollama's cloud — the Ollama app on your machine acts as the bridge to that cloud (authenticated by a key), which is why it still needs to be running locally.",
    ml_cw_ollama_mode_local: "Local",
    ml_cw_ollama_mode_cloud: "Cloud",
    ml_cw_ollama_config_local_title: "Ollama address",
    ml_cw_ollama_config_local_hint: "Default: http://localhost:11434 — only change it if Ollama is on another machine/port.",
    ml_cw_ollama_config_cloud_title: "Ollama Cloud",
    ml_cw_ollama_config_cloud_hint: "The Ollama Cloud key is used together with local Ollama — it still needs to be running.",
    ml_cw_ollama_url_label: "Address (URL)",
    ml_cw_ollama_key_label: "Ollama Cloud key (optional if already configured)",
    ml_cw_test_connection_btn: "🔌 Test connection",
    ml_cw_testing: "Testing…",
    ml_cw_ollama_connected: "Connected — {count} model(s) available",
    ml_cw_ollama_offline_generic: "Could not connect to this address.",
    ml_cw_ollama_models_title: "Choose a model",
    ml_cw_ollama_models_hint: "Selecting one is recommended, not required — Ollama keeps working with whatever model was configured before, if any.",
    ml_cw_ollama_models_empty: "No models found yet.",
    ml_cw_conclusion_ready: "All set!",
    ml_cw_conclusion_confirming: "Confirming…",
    ml_cw_conclusion_model: "Model: {model}",
    ml_cw_custom_endpoint_title: "Server address",
    ml_cw_custom_endpoint_hint: "Any OpenAI-API-compatible server: OpenAI official, LM Studio, vLLM, llamafile, or your own endpoint.",
    ml_cw_custom_label_label: "Name (so you can identify it later)",
    ml_cw_custom_url_label: "Address (URL)",
    ml_cw_custom_key_label: "API key (optional)",
    ml_cw_custom_label_required: "Fill in the name and address before testing.",
    ml_cw_custom_offline_generic: "Could not connect to this address.",
    ml_cw_custom_connected: "Connected — {count} model(s) available",
    ml_cw_custom_models_title: "Choose a model",
    ml_cw_custom_models_hint: "Selecting one is recommended, not required — single-model servers (like llamafile) work without choosing anything.",
    ml_cw_custom_models_empty: "The server responded, but listed no models.",
    ml_cw_custom_no_model_caveat: "Without a chosen model, this only reliably works on single-model servers (llamafile). Servers with multiple models (LM Studio, vLLM, OpenAI official) likely need a specific name.",
    ml_cw_local_scanned: "Folder found — {count} .gguf file(s)",
    ml_cw_native_credential_title: "API key — {name}",
    ml_cw_native_credential_hint: "Paste your API key below. It's saved and verified together — there's no separate non-persisting test, because this provider only confirms the key for real after activating it on the server.",
    ml_cw_native_verify_btn: "🔌 Save and verify",
    ml_cw_native_validating_title: "Verifying key and fetching models…",
    ml_cw_native_validating_hint: "This should take a few seconds.",
    ml_cw_native_offline_generic: "Couldn't confirm the key. Check that it's correct and try again.",
    ...
    ml_local_orphaned_title: '🖥️ Model "{model}" is still loaded, but no longer in use',
    ml_local_orphaned_hint: 'You switched the active provider — this local model is still holding onto your graphics card for nothing. NewClaw does not unload it on its own by design (the same call as never loading on its own, in reverse): you might want to keep it running for something else.',
  ...
  'es-ES': {
    ...
    status_executing_tool: "🔧 Usando {tool}...",
    status_tool_web_search: "🔍 Buscando en internet...",
    status_tool_web_navigate: "🌐 Navegando por la web...",
    status_tool_weather: "🌤️ Consultando el pronóstico del tiempo...",
    status_tool_crypto_analysis: "💰 Analizando criptomonedas...",
    status_tool_crypto_report: "📊 Generando informe de criptomonedas...",
    status_tool_memory_search: "🧠 Consultando la memoria...",
    status_tool_memory_write: "🧠 Guardando en la memoria...",
    status_tool_memory_admin: "🧠 Administrando la memoria...",
    status_tool_manage_memory: "🧠 Gestionando la memoria...",
    status_tool_write: "✍️ Escribiendo archivo...",
    status_tool_edit: "✏️ Editando archivo...",
    status_tool_read: "📖 Leyendo archivo...",
    status_tool_read_document: "📄 Leyendo documento...",
    status_tool_list_workspace: "📁 Listando archivos...",
    status_tool_refresh_workspace: "📁 Actualizando el espacio de trabajo...",
    status_tool_organize_workspace: "🗂️ Organizando archivos...",
    status_tool_analyze_workspace_groups: "🗂️ Analizando archivos...",
    status_tool_exec_command: "⚙️ Ejecutando comando...",
    status_tool_ssh_exec: "🔐 Ejecutando comando remoto...",
    status_tool_api_request: "🌐 Consultando una API...",
    status_tool_cmi_inspect: "🔍 Inspeccionando la conversación...",
    status_tool_send_document: "📎 Enviando el documento...",
    status_tool_send_audio: "🔊 Generando audio...",
    status_tool_powerpoint_control: "📊 Controlando PowerPoint...",
    status_tool_schedule: "⏰ Programando...",
    status_synthesizing: "✍️ Preparando la respuesta...",
    status_goal_replanning: "🔄 Ajustando el plan...",
    status_goal_executing: "⚙️ Trabajando en tu solicitud...",
    status_error: "❌ Error",
    status_bar_model: "Modelo",
    ...
    main_ollama_model_label: "Modelo de reserva de Ollama",
    main_ollama_model_hint: "Se usa solo cuando una llamada a Ollama no especifica un modelo. Normalmente, el Model Router define el modelo por categoría.",
    ...
    ui_error_prefix: "Error",
    ui_model_ready: "✅ ¡\"{model}\" listo!",
    ui_mode_changed: "✅ Modo cambiado a {mode}",
    ui_save_password_error: "❌ Error al guardar la contraseña",
    ml_ov_pending_title: "⏳ Cambio aún no guardado",
    ml_ov_pending_desc: "Cambiaste: {campos}. El panel de arriba muestra lo que está vigente AHORA en el servidor — haz clic en <strong>Guardar</strong> para que tu cambio tenga efecto.",
    ml_tab_advanced: "Avanzado",
    ml_tab_wizard: "Asistente de Configuración",
    ...
    ml_ov_loading: "cargando el modelo…",
    ml_dup_endpoint_title: "ℹ️ Dos proveedores en la misma dirección",
    ml_dup_endpoint_item: "<strong>{labels}</strong> apuntan a <code>{endereco}</code> — es el mismo servidor con dos nombres. Funciona, pero si algo falla no habrá forma de saber cuál de los dos está respondiendo.",
    ...
    ml_routing_apply: "✅ Aplicar",
    ml_routing_apply_why_nosel: "Elige un modelo de la lista de abajo para poder aplicar.",
    ml_routing_apply_why_same: "{model} ya es el modelo aplicado en esta categoría — no hay nada que cambiar.",
    ...
    ml_tab_providers_guide: "🔌 Aquí conectas NewClaw a un servicio de IA.<br><br><strong>Ollama</strong> apunta a tu propia computadora (localhost:11434), pero los modelos predeterminados son los <strong>:cloud</strong> — esos corren en los servidores de Ollama, son <strong>de pago</strong> y requieren una clave de API (campo abajo).<br>Para no tener costo, instala un modelo <strong>local</strong> en <strong>Agregar Modelo</strong> y selecciónalo en <strong>Elegir Modelo</strong>.<br>¿Prefieres usar otro servicio (Google Gemini, OpenRouter, etc.)? Pega su clave de API aquí.",
    ...
    ml_cw_browse_btn: "Examinar...",
    ml_cw_browse_hint: "Abre una ventana para elegir la carpeta",
    ml_cw_browse_title: "Elige la carpeta de los modelos",
    ml_cw_browse_empty: "No hay subcarpetas aquí.",
    ml_cw_browse_up: "Subir",
    ml_cw_browse_use: "Usar esta carpeta",
    ml_local_scan_btn: "🔍 Buscar modelos",
    ml_local_scanning: "Buscando…",
    ...
    ml_param_temp: "Temperatura de muestreo. Más alto = respuestas más variadas; más bajo = más predecibles. Cada modelo suele tener una recomendación oficial distinta.",
    ml_param_topp: "Recorta el muestreo a los tokens más probables hasta sumar esta probabilidad. Valores comunes: 0.9 a 0.95.",
    ml_param_topk: "Limita el muestreo a los N tokens más probables en cada paso.",
    ml_param_minp: "Descarta tokens con probabilidad mucho menor que la del más probable. Alternativa más moderna a top-p/top-k.",
    ml_param_repeatpenalty: "Penaliza tokens usados recientemente, para reducir la repetición.",
    ml_param_presencepenalty: "Penaliza cualquier token que ya apareció en la respuesta, incentivando vocabulario nuevo.",
    ml_param_flashattn: "Usa atención optimizada (más rápida, menos memoria) cuando el servidor y la GPU lo soportan.",
    ml_param_jinja: "Usa la plantilla de chat integrada en el archivo del modelo (formato Jinja) en vez de la del servidor.",
    ...
    ml_wizard_entry_btn: "Asistente de Configuración Rápida",
    ml_wizard_loading: "Verificando…",
    ml_wizard_step1_title: "¿Dónde están tus modelos?",
    ml_wizard_step1_hint: "Indica la carpeta de tu computadora donde están los archivos .gguf.",
    ml_wizard_step_load_title: "Elige un modelo para cargar",
    ml_wizard_step_load_hint: "Los modelos más grandes tardan más en cargar.",
    ml_wizard_step_confirming: 'Confirmando que "{model}" está listo para usarse…',
    ml_wizard_step_done: '✅ ¡Todo listo! NewClaw ya está conversando con "{model}".',
    ml_wizard_close_btn: "Cerrar",
    ml_wizard_dismiss_btn: "No destacar este botón de nuevo",
    ml_cw_choose_title: "¿Qué proveedor quieres configurar?",
    ml_cw_choose_hint: "Elige un proveedor para empezar — los siguientes pasos cambian según lo que necesite.",
    ml_cw_provider_custom: "Otro / OpenAI-Compatible",
    ml_cw_wip_title: "En construcción",
    ml_cw_wip_hint: "Este paso todavía se está construyendo — vuelve pronto.",
    ml_cw_btn_cancel: "Cancelar",
    ml_cw_btn_back: "← Volver",
    ml_cw_btn_next: "Siguiente →",
    ml_cw_btn_finish: "Concluir",
    ml_cw_ollama_mode_title: "Ollama: ¿local o nube?",
    ml_cw_ollama_mode_hint: "Local usa modelos descargados en tu equipo. Cloud usa modelos más grandes alojados en la nube de Ollama — el Ollama instalado en tu equipo hace de puente con esa nube (autenticada con una clave), por eso igual necesita estar corriendo localmente.",
    ml_cw_ollama_mode_local: "Local",
    ml_cw_ollama_mode_cloud: "Cloud",
    ml_cw_ollama_config_local_title: "Dirección de Ollama",
    ml_cw_ollama_config_local_hint: "Por defecto: http://localhost:11434 — cámbialo solo si Ollama está en otra máquina/puerto.",
    ml_cw_ollama_config_cloud_title: "Ollama Cloud",
    ml_cw_ollama_config_cloud_hint: "La clave de Ollama Cloud se usa junto con Ollama local — sigue necesitando estar corriendo.",
    ml_cw_ollama_url_label: "Dirección (URL)",
    ml_cw_ollama_key_label: "Clave de Ollama Cloud (opcional si ya está configurada)",
    ml_cw_test_connection_btn: "🔌 Probar conexión",
    ml_cw_testing: "Probando…",
    ml_cw_ollama_connected: "Conectado — {count} modelo(s) disponible(s)",
    ml_cw_ollama_offline_generic: "No se pudo conectar a esta dirección.",
    ml_cw_ollama_models_title: "Elige un modelo",
    ml_cw_ollama_models_hint: "Seleccionar uno es recomendable, no obligatorio — Ollama sigue funcionando con el modelo ya configurado antes, si lo hay.",
    ml_cw_ollama_models_empty: "Todavía no se encontraron modelos.",
    ml_cw_conclusion_ready: "¡Todo listo!",
    ml_cw_conclusion_confirming: "Confirmando…",
    ml_cw_conclusion_model: "Modelo: {model}",
    ml_cw_custom_endpoint_title: "Dirección del servidor",
    ml_cw_custom_endpoint_hint: "Cualquier servidor compatible con la API de OpenAI: OpenAI oficial, LM Studio, vLLM, llamafile, o tu propia dirección.",
    ml_cw_custom_label_label: "Nombre (para identificarlo después)",
    ml_cw_custom_url_label: "Dirección (URL)",
    ml_cw_custom_key_label: "Clave de API (opcional)",
    ml_cw_custom_label_required: "Completa el nombre y la dirección antes de probar.",
    ml_cw_custom_offline_generic: "No se pudo conectar a esta dirección.",
    ml_cw_custom_connected: "Conectado — {count} modelo(s) disponible(s)",
    ml_cw_custom_models_title: "Elige un modelo",
    ml_cw_custom_models_hint: "Seleccionar uno es recomendable, no obligatorio — los servidores de un solo modelo (como llamafile) funcionan sin elegir nada.",
    ml_cw_custom_models_empty: "El servidor respondió, pero no listó ningún modelo.",
    ml_cw_custom_no_model_caveat: "Sin modelo elegido, esto solo funciona de forma confiable en servidores de un solo modelo (llamafile). Servidores con varios modelos (LM Studio, vLLM, OpenAI oficial) probablemente necesiten un nombre específico.",
    ml_cw_local_scanned: "Carpeta encontrada — {count} archivo(s) .gguf",
    ml_cw_native_credential_title: "Clave de API — {name}",
    ml_cw_native_credential_hint: "Pega tu clave de API abajo. Se guarda y se verifica junto — no hay una prueba separada que no grabe nada, porque este proveedor solo confirma la clave de verdad después de activarla en el servidor.",
    ml_cw_native_verify_btn: "🔌 Guardar y verificar",
    ml_cw_native_validating_title: "Verificando clave y buscando modelos…",
    ml_cw_native_validating_hint: "Esto debería tomar pocos segundos.",
    ml_cw_native_offline_generic: "No se pudo confirmar la clave. Revisa que esté correcta e inténtalo de nuevo.",
    ...
    ml_local_orphaned_title: '🖥️ El modelo "{model}" sigue cargado, pero ya no se usa',
    ml_local_orphaned_hint: 'Cambiaste el proveedor en uso — este modelo local sigue ocupando la tarjeta gráfica sin necesidad. NewClaw no lo descarga por su cuenta a propósito (la misma decisión de nunca cargarlo solo, al revés): quizás quieras mantenerlo activo para otra cosa.',
