# Caminho relativo à raiz do repositório — execute a partir dela.
$content = Get-Content 'src/dashboard/DashboardServer.ts' -Raw
...
if ($content -match $pattern) {
    ...
    Set-Content 'src/dashboard/DashboardServer.ts' $newContent -Encoding UTF8
