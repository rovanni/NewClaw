...
**Dívida Arquitetural Restante:** 10 ARCH (5 cards executáveis restantes + ARCH-008/ARCH-009/ARCH-013/ARCH-018 adiados + ARCH-021 formalmente absorvido em ARCH-020, sem sprint própria) — correção de aritmética nesta atualização (26 total − 16 concluídos = 10, não 8 como constava antes)
