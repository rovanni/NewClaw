...
| 2026-09-S21 | Set/2026 | Decision Ownership | ARCH-013 | ⏸ | CP03, S14 | (pendente — commit ao final desta Sprint) | Adiado antes de codificar — premissa CORRETA e prescrição viável, mas fundir sem ajuste perde sinal `stepSuccessConfident` (7º modo de falha); fix desenhado em `docs/issues/011` |
