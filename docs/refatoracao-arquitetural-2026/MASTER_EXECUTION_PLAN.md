...
**Status Geral:** 🟢 Em execução — Fase 0, S01-S13/S15/S16/S19/S20/S23, Checkpoints CP01/CP02/CP03 concluídos; S14/S17/S18/S21 adiadas (ver abaixo)
**Progresso:** 17 / 26 ARCH concluídos (~65%) — ARCH-008 (S17), ARCH-009 (S14), ARCH-013 (S21) e ARCH-018 (S18) adiados, não contam como concluídos nem como pendências simples. ARCH-024 concluído (RFC S19 + Impl S23). ARCH-015 tem RFC aprovada (S20), só conta como concluído quando a Impl (S26) landar — Definition of Done exige as duas etapas
**Sprint Atual:** Nenhuma em andamento (S23 concluída — próxima é 2026-10-S24)
**Próxima Sprint:** 2026-10-S24 (ARCH-020) — decompor `GoalExecutionLoop.runLoopInternal()` (~1030 linhas). ⚠ Maior esforço do programa (empate com S25) — mapear TODOS os efeitos colaterais capturados por closure antes de extrair qualquer método; Validação Progressiva completa até etapa 4 é obrigatória, não opcional.
**Epic Atual:** Epic A concluído; Epic B "concluído" no sentido de nenhum item executável restante nesta ordem — ARCH-005/006/007/010/011 feitos, ARCH-008 adiado, ARCH-012 deliberadamente deferido para o fim do programa; Epic C — ARCH-014/015(RFC)/016/017 feitos/aprovados, ARCH-013/018 adiados; Epic D em andamento — ARCH-022/023/024 feitos, ARCH-020/019 restantes (S24/S25); Epic E concluído — ARCH-025/026 feitos
**Próximo Marco:** 2026-11-CP04
**Última Atualização:** 2026-07-18 (Sprint S23 concluída)
**Build:** 🟢 `npm run build` limpo
**Testes:** 🟢 125/125
**Regressão:** 🟢 125/125 (pós-S23, `S44` corrigido)
**Riscos Abertos:** 0 materializados — nota permanente: a VPS `venus@10.0.0.10` usada para validação Linux tem histórico de exigir `.env`/`WORKSPACE_DIR` explícito (skill `verify`) para não gerar falso-positivo — ver `docs/issues/002`. S16 (ARCH-005) teve o escopo redesenhado na Fase 1/2 para um fix cirúrgico — risco real ficou bem menor que o estimado, mas isso NÃO deve ser extrapolado para S24/S25 (ver revisão de riscos do CP03) — a redução veio de a premissa do card estar errada, não de a área ser inerentemente mais fácil. S23 também teve risco real baixo (confirmado, não presumido — etapa 4 real rodou e não achou problema; note que `tsc` sozinho NÃO cobriria um erro de wiring aqui, já que todo campo de `deliveryTracking` é opcional e um esquecimento de propagação seria um no-op silencioso, não um erro de tipo) — mesma ressalva: não extrapolar para S24/S25, que mexem em métodos de 1000+ linhas sem cobertura de teste de sistema completa hoje.
...
**Dívida Arquitetural Restante:** 9 ARCH (ARCH-020/S24, ARCH-019/S25, ARCH-015-Impl/S26, ARCH-012/S27 — 4 cards executáveis restantes + ARCH-008/ARCH-009/ARCH-013/ARCH-018 adiados + ARCH-021 formalmente absorvido em ARCH-020, sem sprint própria) — 26 total − 17 concluídos (S23 fechou ARCH-024) = 9
