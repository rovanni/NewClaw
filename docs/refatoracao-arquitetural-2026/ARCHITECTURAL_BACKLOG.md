...
### ARCH-015 — RFC: Args obrigatórios gerados do schema da tool ✅ RFC concluída (2026-09, Sprint S20) — aprovada com escopo REDUZIDO
...
### ARCH-024 — RFC + Implementação: `DeliveryTrackingContext` (consolidar callbacks de `ChannelContext`) ✅ RFC concluída (2026-09, Sprint S19) — aprovada com escopo corrigido
